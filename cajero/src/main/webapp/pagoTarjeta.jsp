...
<html>
	...
	<div>
		...
		<form href="pagoTarjeta" method="post">
			<ul>
				<li>
					<label for="nroTarjeta">Tarjeta: </label>
					<select name="nroTarjeta">
						<option value="0">-- Seleccione una tarjeta --</option>
						<c:forEach items="${tarjetas}" var="t">
							<option value="${t.nroTarjeta}">${t.nroTarjeta} - ${t.lineaDeCredito} - ${t.moneda.nombre} </option>
						</c:forEach>
					</select>
				</li>
				<li>
