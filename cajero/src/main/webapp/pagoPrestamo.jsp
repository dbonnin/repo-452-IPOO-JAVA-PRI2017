...
<html>
	...
	<div>
		...
		<form href="pagoPrestamo" method="post">
			<ul>
				<li>
					<label for="nroPrestamo">Préstamo: </label>
					<select name="nroPrestamo">
						<option value="0">-- Seleccione un Préstamo --</option>
						<c:forEach items="${prestamos}" var="p">
							<option value="${p.nroPrestamo}">${p.capital} - ${p.moneda.nombre} </option>
						</c:forEach>
					</select>
				</li>
				<li>
